...
public class AdminDashboardController implements Initializable {
    ...
    @FXML
    private TextField authority_entity;
    @FXML
    ...
    public void setAuthority_Var(String authority_Var) {
        this.authority_Var = authority_Var;
    }
    ...
    private void submit_button(ActionEvent event) 
    {
        try
        {
            ...
            String updateQuery = "UPDATE admins SET EMAIL='"+email_entity.getText()+"',CONTACT_NUMBER='"+Integer.valueOf(contactNumber_entity.getText())+"',ADDRESS='"+address_entity.getText()+"' WHERE ADMIN_ID='"+id_entity_Var+"'";
